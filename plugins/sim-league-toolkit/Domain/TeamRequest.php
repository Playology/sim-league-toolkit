<?php
  ...
  class TeamRequest implements AggregateRoot, Deletable, ProvidesPersistableArray, Saveable {
    use HasIdentity;
    ...
    public static function delete(int $id): void {
      TeamsRepository::deleteRequest($id);
    }
    ...
    public static function get(int $id): ?self {
      return self::fromStdClass(TeamsRepository::getRequestById($id));
    }
    ...
    public static function listPendingByMemberId(int $memberId): array {
      return array_map(fn($row) => self::fromStdClass($row), TeamsRepository::listPendingRequestsByMemberId($memberId));
    }
    ...
    public static function listPendingByTeamId(int $teamId): array {
      return array_map(fn($row) => self::fromStdClass($row), TeamsRepository::listPendingRequestsByTeamId($teamId));
    }
    ...
    public function save(): self {
      if (!$this->hasId()) {
        $this->setId(TeamsRepository::addRequest($this->toArray()));
      } else {
        TeamsRepository::updateRequest($this->getId(), $this->toArray());
      }
